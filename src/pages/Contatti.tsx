    ...
    <section className="sectionPadding">
      <div className="container">
        ...
        >
          ...
          <p>
            Siamo pronti ad accoglierti e a guidarti nel cuore barocco della
            costa sicula
          </p>
        </div>
        ...
        <div className="row g-4">
            ...
            <div className="card h-100 border-0 shadow-sm p-4 p-md-5 bg-white">
              ...
              <div className="d-flex flex-column gap-4 pb-4 pt-4">
                ...
                <div className="d-flex align-items-start gap-3">
                  <div
                    className={`p-2 rounded-3 d-flex align-items-center justify-content-center ${styles["icon-badge"]}`}
                  >
                  ...
                  <div>
                    ...
                    <p className="text-secondary small mb-0">
                      Via Lungomare, Postazione Centrale • 91010 San Vito Lo
                      Capo (Trapani), Sicilia
                    </p>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-secondary small mb-0">
                      Spiaggia: 08:30 - 19:30 • Ristorante: 12:30 - 15:30, 20:00
                      - 23:30
                    </p>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-secondary small mb-0">
                      +39 0931 1234567 • Servizio di concierge attivo 24/7
                    </p>
                  </div>
                </div>
              ...
              <div
                className={`mt-auto pt-4 border-top d-flex justify-content-between align-items-center text-muted ${styles.customFontInfo}`}
              >
          ...
          <div className="col-lg-6">
            <div
              className={`h-100 p-4 p-md-5 d-flex flex-column justify-content-end text-white shadow-sm ${styles["info-image-card"]}`}
            >
              <div className="mb-3">
